...
// ===================================================================
const ISSUES = [
  { date: '02 Apr 2026', title: 'A springboard, not a crisis', excerpt: 'What 40 teachers told us this month — and what it changes about how we\'re designing the spring cohort.', tag: 'Field notes' },
  { date: '18 Mar 2026', title: 'The loud narrative, and the quieter one', excerpt: 'The Silicon Valley framing is loud and well-funded. Here\'s what happens when you let the room be quieter.', tag: 'Essay' },
  { date: '01 Mar 2026', title: 'Why we don\'t start with the tools', excerpt: 'Teachers in Germany have no structured AI support. Opening with a product demo solves the wrong problem.', tag: 'Essay' },
  { date: '14 Feb 2026', title: 'On AI agency, acceleration, governance', excerpt: 'Notes from a conversation with researchers who are done with the word "alignment".', tag: 'Conversation' },
  { date: '28 Jan 2026', title: 'The parent dimension', excerpt: 'Kids are using AI more than their parents. We have almost no structured support for the adults at home.', tag: 'Field notes' },
  { date: '10 Jan 2026', title: 'What we learned running the pilot', excerpt: 'Six weeks, fourteen teachers, one cohort. Here\'s the honest retrospective — including what didn\'t work.', tag: 'Retrospective' },
];
        ...
        <div className="news-hero__inner">
          ...
          <form className="news-form" onSubmit={(e) => { e.preventDefault(); setSent(true); }}>
            ...
            <div className="news-form__row">
              <input className="news-form__input" type="email" required placeholder="you@work.com"
